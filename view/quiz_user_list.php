...
<tr>
<th colspan="4">User Analysis <a href="/jee/quiz/export_users/<?php echo $quiz_id; ?>" class="btn-primary small-btn">Export List</a> </th>
</tr>
<tr>
<th>Name</th>
<th>Marks</th>
...
echo '<td>Completed (<a href="/jee/quiz/user_report/'.$quiz_id.'/'.$value['ID'].'">View Report</a>)</td>';
echo '</tr>';
}
