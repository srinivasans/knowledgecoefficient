...
<form id="answer_form" name="answer_form" method="POST" action="/jee/quiz/finish/<?php if(isset($quiz['ID'])){echo $quiz['ID'];} ?>/embed">
<div class="row-fluid">
<div class="span12">
<div class="tabbable"> <!-- Only required for left/right tabs -->
  
  <div class="tab-content tab-embed" id="tab-content-embed">
	<?php	
	...
	echo '<div class="tab-pane active" id="tab">';
			...
			echo '</div>';			
			echo '<div class="finish-embed" style="overflow-y:auto"><button class="btn btn-success finish-btm" style="margin-right:5px" id="finish-btm" onclick="finish()">Save</button><button onclick="finish_submit()" id="finish-head" class="btn btn-warning">Finish Test</button></div>';
