...
<div style="margin-right:1%"><button style="margin-right:1%" class="btn" data-dismiss="modal" aria-hidden="true">Close</button><a href="/jee/test/check_constraints/<?php echo $test_id; ?>" class="btn btn-info">Set On-Board</a></div>
</div>
</div>
...
<legend>Set On-Board <div class="pull-right" style="margin-right:1%"><a href="/jee/test/add_settings/<?php echo $test_id; ?>" class="btn btn-info">Settings</a></div>
<div class="pull-right" style="margin-right:1%"><a href="/jee/test/add_questions/<?php echo $test_id; ?>" class="btn btn-success">Questions</a></div>
