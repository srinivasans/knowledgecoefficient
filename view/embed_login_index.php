...
<div class="row-fluid">
<div class="span3"></div>
<div class="span6" id="main-title-embed">Knowledge Coefficient</div>
<div class="span3"></div>
</div>
...
<form method="POST" action="/jee/signup/vsignup" id="signup_form" target="_blank">
<tr>
<td>
...
<tr>
<td>
<input type="password" name="institute" class="text_input" placeholder="Institute"/>
</td>
</tr>
<tr>
<td>
...
<div class="fb-login"><a href="/jee?key=signup&action=facebook_login&uid=embed&callback=<?php echo $callback; ?>"><img class="connect-img" src="/jee/img/connect.png"/></a></div>
