...
<h4 id="home-update-head"> Quiz Master</h4>

<div class="row-fluid">

<div class="span5">
<h4 id="home-inner-head">Quizzes Created  <a href="/jee/quiz/create" class="btn-success small-btn"><i class="icon-plus-sign"></i>Create Quiz</a></h4>
